...
const ModalPortalHost = (props) => {
    ...
    const style = react_native_1.StyleSheet.flatten([props.style, props.fluid ? { flex: 1 } : undefined]);
    return (<native_1.NativeModalPortalHost style={style} fluid={props.fluid} hostId={props.hostId} onRegistered={({ nativeEvent }) => {
